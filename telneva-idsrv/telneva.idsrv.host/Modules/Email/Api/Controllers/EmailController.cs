...
using telneva.idsrv.host.Modules.Email.Application.UseCases.Send;

namespace telneva.idsrv.host.Modules.Email.Api.Controllers
{
    ...
    {
        [HttpPost]
        [ProducesResponseType(type: typeof(SendEmailResponse), statusCode: StatusCodes.Status201Created)]
